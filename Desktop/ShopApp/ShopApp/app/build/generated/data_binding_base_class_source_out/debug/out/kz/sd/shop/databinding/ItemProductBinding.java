...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull CardView rootView, @NonNull TextView bonus,
      @NonNull ImageView imageView, @NonNull TextView price, @NonNull TextView title) {
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((CardView) rootView, bonus, imageView, price, title);
    }
