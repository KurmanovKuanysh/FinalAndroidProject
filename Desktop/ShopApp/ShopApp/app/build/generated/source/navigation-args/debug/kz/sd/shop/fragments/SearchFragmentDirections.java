...
public class SearchFragmentDirections {
  ...
  public static ActionSearchFragmentToProductDetailsFragment actionSearchFragmentToProductDetailsFragment(
    ...
    return new ActionSearchFragmentToProductDetailsFragment(Product);
  }

  @NonNull
  public static NavDirections actionSearchFragmentToHome() {
    return new ActionOnlyNavDirections(R.id.action_searchFragment_to_home);
  }
  ...
  public static class ActionSearchFragmentToProductDetailsFragment implements NavDirections {
    ...
    private ActionSearchFragmentToProductDetailsFragment(@NonNull Product Product) {
      if (Product == null) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSearchFragmentToProductDetailsFragment setProduct(@NonNull Product Product) {
      if (Product == null) {
        throw new IllegalArgumentException("Argument \"Product\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("Product", Product);
    ...
    public boolean equals(Object object) {
      ...
      ActionSearchFragmentToProductDetailsFragment that = (ActionSearchFragmentToProductDetailsFragment) object;
    ...
    public String toString() {
      return "ActionSearchFragmentToProductDetailsFragment(actionId=" + getActionId() + "){"
          + "Product=" + getProduct()
          + "}";
    }
  }
